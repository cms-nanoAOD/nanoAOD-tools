...
def sub_writer(sample, n, files, folder):
    ...
    f.write("executable              = tree_skimmer_for_trigger.py\n")
...
for sample in samples:
    ...
    f = open("../../crab/macros/files/" + sample.label + "_for_trigger.txt", "r")
    ...
    if(isMC):
        for i, files in enumerate(files_list):
            ...
            print("python tree_skimmer.py " + sample.label + " " + str(i) + " " + str(files) + " remote")
    else:
        for i in range(len(files_list)/split+1):
            ...
            print("python tree_skimmer_for_trigger.py " + sample.label + " " + str(i) + " " + ",".join( e for e in files_list[split*i:split*(i+1)]) + " remote")
