...
class jetmetUncertaintiesProducer(Module):
    def __init__(self, era, globalTag, jesUncertainties = [ "Total" ], archive=None, jetType = "AK4PFchs", redoJEC=False, noGroom=False, metBranchName="MET", jerTag="", isData=False, applySmearing=True):
#    def __init__(self, era, globalTag, jesUncertainties = [ "Total" ], archive=None, globalTagProd=None, jetType = "AK4PFchs", metBranchName="MET", jerTag="", isData=False, applySmearing=True):
        ...
        if len(jesUncertainties) == 1 and jesUncertainties[0] == "Total":
            ...
            self.jesUncertaintyInputFileName = "Autumn18_RunB_V19_DATA/" + globalTag + "_UncertaintySources_" + jetType + ".txt"
    ...
    def analyze(self, event):
        ...
        if self.corrMET :
            ...
            ( Puppimet_px,         Puppimet_py        ) = ( Puppimet.pt*math.cos(Puppimet.phi), Puppimet.pt*math.sin(Puppimet.phi) )
        ...
        for jet in jets:
            ...
            if self.corrMET and jet_pt_nom > self.unclEnThreshold:
                ...
                Puppimet_px_nom = Puppimet_px_nom - (jet_pt_nom - jet_pt)*jet_cosPhi
                Puppimet_py_nom = Puppimet_py_nom - (jet_pt_nom - jet_pt)*jet_sinPhi
                Puppimet_px_jerUp   = Puppimet_px_jerUp   - (jet_pt_jerUp   - jet_pt_nom)*jet_cosPhi
                Puppimet_py_jerUp   = Puppimet_py_jerUp   - (jet_pt_jerUp   - jet_pt_nom)*jet_sinPhi
                Puppimet_px_jerDown = Puppimet_px_jerDown - (jet_pt_jerDown - jet_pt_nom)*jet_cosPhi
                Puppimet_py_jerDown = Puppimet_py_jerDown - (jet_pt_jerDown - jet_pt_nom)*jet_sinPhi

                Rawmet_px_nom = Rawmet_px_nom - (jet_pt_nom - jet_pt)*jet_cosPhi
                Rawmet_py_nom = Rawmet_py_nom - (jet_pt_nom - jet_pt)*jet_sinPhi
                Rawmet_px_jerUp   = Rawmet_px_jerUp   - (jet_pt_jerUp   - jet_pt_nom)*jet_cosPhi
                Rawmet_py_jerUp   = Rawmet_py_jerUp   - (jet_pt_jerUp   - jet_pt_nom)*jet_sinPhi
                Rawmet_px_jerDown = Rawmet_px_jerDown - (jet_pt_jerDown - jet_pt_nom)*jet_cosPhi
                Rawmet_py_jerDown = Rawmet_py_jerDown - (jet_pt_jerDown - jet_pt_nom)*jet_sinPhi
                ...
                for jesUncertainty in self.jesUncertainties:
                    ...
                    Puppimet_px_jesUp[jesUncertainty]   = Puppimet_px_jesUp[jesUncertainty]   - (jet_pt_jesUp[jesUncertainty]   - jet_pt_nom)*jet_cosPhi
                    Puppimet_py_jesUp[jesUncertainty]   = Puppimet_py_jesUp[jesUncertainty]   - (jet_pt_jesUp[jesUncertainty]   - jet_pt_nom)*jet_sinPhi
                    Puppimet_px_jesDown[jesUncertainty] = Puppimet_px_jesDown[jesUncertainty] - (jet_pt_jesDown[jesUncertainty] - jet_pt_nom)*jet_cosPhi
                    Puppimet_py_jesDown[jesUncertainty] = Puppimet_py_jesDown[jesUncertainty] - (jet_pt_jesDown[jesUncertainty] - jet_pt_nom)*jet_sinPhi

                    Rawmet_px_jesUp[jesUncertainty]   = Rawmet_px_jesUp[jesUncertainty]   - (jet_pt_jesUp[jesUncertainty]   - jet_pt_nom)*jet_cosPhi
                    Rawmet_py_jesUp[jesUncertainty]   = Rawmet_py_jesUp[jesUncertainty]   - (jet_pt_jesUp[jesUncertainty]   - jet_pt_nom)*jet_sinPhi
                    Rawmet_px_jesDown[jesUncertainty] = Rawmet_px_jesDown[jesUncertainty] - (jet_pt_jesDown[jesUncertainty] - jet_pt_nom)*jet_cosPhi
                    Rawmet_py_jesDown[jesUncertainty] = Rawmet_py_jesDown[jesUncertainty] - (jet_pt_jesDown[jesUncertainty] - jet_pt_nom)*jet_sinPhi
        ...
        if self.corrMET :
            ...
            # Tpropagate effect of jet energy smearing to MET           
            Puppimet_px_jerUp   = Puppimet_px_jerUp   + (Puppimet_px_nom - Puppimet_px)
            Puppimet_py_jerUp   = Puppimet_py_jerUp   + (Puppimet_py_nom - Puppimet_py)
            Puppimet_px_jerDown = Puppimet_px_jerDown + (Puppimet_px_nom - Puppimet_px)
            Puppimet_py_jerDown = Puppimet_py_jerDown + (Puppimet_py_nom - Puppimet_py)
            ...
            # propagate effect of jet energy smearing to MET           
            Rawmet_px_jerUp   = Rawmet_px_jerUp   + (Rawmet_px_nom - Rawmet_px)
            Rawmet_py_jerUp   = Rawmet_py_jerUp   + (Rawmet_py_nom - Rawmet_py)
            Rawmet_px_jerDown = Rawmet_px_jerDown + (Rawmet_px_nom - Rawmet_px)
            Rawmet_py_jerDown = Rawmet_py_jerDown + (Rawmet_py_nom - Rawmet_py)
            for jesUncertainty in self.jesUncertainties:
                ...
                Puppimet_px_jesUp[jesUncertainty]   = Puppimet_px_jesUp[jesUncertainty]   + (Puppimet_px_nom - Puppimet_px)
                Puppimet_py_jesUp[jesUncertainty]   = Puppimet_py_jesUp[jesUncertainty]   + (Puppimet_py_nom - Puppimet_py)
                Puppimet_px_jesDown[jesUncertainty] = Puppimet_px_jesDown[jesUncertainty] + (Puppimet_px_nom - Puppimet_px)
                Puppimet_py_jesDown[jesUncertainty] = Puppimet_py_jesDown[jesUncertainty] + (Puppimet_py_nom - Puppimet_py)

                Rawmet_px_jesUp[jesUncertainty]   = Rawmet_px_jesUp[jesUncertainty]   + (Rawmet_px_nom - Rawmet_px)
                Rawmet_py_jesUp[jesUncertainty]   = Rawmet_py_jesUp[jesUncertainty]   + (Rawmet_py_nom - Rawmet_py)
                Rawmet_px_jesDown[jesUncertainty] = Rawmet_px_jesDown[jesUncertainty] + (Rawmet_px_nom - Rawmet_px)
                Rawmet_py_jesDown[jesUncertainty] = Rawmet_py_jesDown[jesUncertainty] + (Rawmet_py_nom - Rawmet_py)
            ...
            Puppimet_px_unclEnUp    = Puppimet_px_unclEnUp   + (Puppimet_px_nom - Puppimet_px)
            Puppimet_py_unclEnUp    = Puppimet_py_unclEnUp   + (Puppimet_py_nom - Puppimet_py)
            Puppimet_px_unclEnDown  = Puppimet_px_unclEnDown + (Puppimet_px_nom - Puppimet_px)
            Puppimet_py_unclEnDown  = Puppimet_py_unclEnDown + (Puppimet_py_nom - Puppimet_py)

            Rawmet_px_unclEnUp    = Rawmet_px_unclEnUp   + (Rawmet_px_nom - Rawmet_px)
            Rawmet_py_unclEnUp    = Rawmet_py_unclEnUp   + (Rawmet_py_nom - Rawmet_py)
            Rawmet_px_unclEnDown  = Rawmet_px_unclEnDown + (Rawmet_px_nom - Rawmet_px)
            Rawmet_py_unclEnDown  = Rawmet_py_unclEnDown + (Rawmet_py_nom - Rawmet_py)
