...
if 'muon' in period:
    ...
    nbins_muy = len(edges_mux)-1
    edges_mux = array.array('f', [30., 40., 50., 60., 100., 200., 1000.])
    nbins_mux = len(edges_muy)-1
...
for inpfile in inpfiles[period]:
    ...
    if 'muon' in period:
        if 'Data' not in infile.GetName():
            tree.Project("HLT_num", "abs(muon_eta):muon_pt", "w_nominal*PFSF*puSF*isdileptonic*muon_SF*passed_ele*(passed_mu||passed_ht)")
            tree.Project("HLT_den", "abs(muon_eta):muon_pt", "w_nominal*PFSF*puSF*isdileptonic*muon_SF*passed_ele")
            ...
            tree.Project("HLT_num", "abs(muon_eta):muon_pt", "w_nominal*PFSF*puSF*isdileptonic*passed_ele*(passed_mu||passed_ht)")
            tree.Project("HLT_den", "abs(muon_eta):muon_pt", "w_nominal*PFSF*puSF*isdileptonic*passed_ele")
            #tree.Project("HLT_num", "Event_HT", "w_nominal*PFSF*puSF*isdileptonic*passed_ele*(passed_mu||passed_ht)")
            #tree.Project("HLT_den", "Event_HT", "w_nominal*PFSF*puSF*isdileptonic*passed_ele")
        print h_HLT_num.Integral()
    else:
        if 'Data' not in infile.GetName():
            tree.Project("HLT_num", "electron_pt:abs(electron_eta)", "w_nominal*PFSF*puSF*isdileptonic*electron_SF*passed_mu*(passed_ele||passed_ht)")
            tree.Project("HLT_den", "electron_pt:abs(electron_eta)", "w_nominal*PFSF*puSF*isdileptonic*electron_SF*passed_mu")
            ...
            tree.Project("HLT_num", "electron_pt:abs(electron_eta)", "w_nominal*PFSF*puSF*isdileptonic*passed_mu*(passed_ele||passed_ht)")
            tree.Project("HLT_den", "electron_pt:abs(electron_eta)", "w_nominal*PFSF*puSF*isdileptonic*passed_mu")
            #tree.Project("HLT_num", "Event_HT", "w_nominal*PFSF*puSF*isdileptonic*passed_mu*(passed_ele||passed_ht)")
            #tree.Project("HLT_den", "Event_HT", "w_nominal*PFSF*puSF*isdileptonic*passed_mu")
    #print h_HLT_num.Integral()
