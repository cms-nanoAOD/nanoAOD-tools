...
#p=PostProcessor(".",fnames,"Jet_pt>150","keep_and_drop.txt",[jetmetUncertainties2016(),exampleModuleConstr()],provenance=True)
p=PostProcessor(".",fnames,"Jet_pt>150","keep_and_drop.txt",[jmeCorrections(),exampleModuleConstr()],provenance=True)
p.run()
