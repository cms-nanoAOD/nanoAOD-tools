...
"/WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8/"+tag_2018+"-v1/NANOAODSIM"
"/WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8/"+tag_2017+"-v1/NANOAODSIM"
...
TT_Mtt700to1000_2017.dataset = "/TT_Mtt-700to1000_TuneCP5_13TeV-powheg-pythia8/"+tag_2017+"-v1/NANOAODSIM"
...
TT_Mtt_2017 = sample(ROOT.kRed, 1, 1001, "#mathrm{t#bar{t}}", "TT_Mtt")
TT_Mtt_2017.components = [TT_Mtt700to1000_2017, TT_Mtt1000toInf_2017]

WJetsHT200to400_2017 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT400to600_2017 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT600to800_2017 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT800to1200_2017 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT1200to2500_2017 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT2500toInf_2017 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJets_2017 = sample(ROOT.kGreen+2, 1, 1001, "W + Jets", "WJets")
...
TT_Mtt_2018 = sample(ROOT.kRed, 1, 1001, "#mathrm{t#bar{t}}", "TT_Mtt")
TT_Mtt_2018.components = [TT_Mtt700to1000_2018, TT_Mtt1000toInf_2018]

WJetsHT200to400_2018 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT400to600_2018 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT600to800_2018 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT800to1200_2018 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT1200to2500_2018 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJetsHT2500toInf_2018 = sample(ROOT.kYellow-7, 1, 1001, "W + Jets", "WJets")
...
WJets_2018 = sample(ROOT.kGreen+2, 1, 1001, "W + Jets", "WJets")
