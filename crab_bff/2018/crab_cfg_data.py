...
config.JobType.inputFiles = ['job_2018_data_crab.py', '../../scripts/haddnano.py', '../../scripts/keep_and_drop.txt', 'Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt']
