...
config.General.requestName = 'WZ_TuneCP5_13TeV-pythia8_RunIIAutumn18NanoAODv7-Na'
...
config.Data.outputDatasetTag = 'WZ_TuneCP5_13TeV-pythia8_RunIIAutumn18NanoAODv7-Na'
