...
config.General.requestName = 'ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-'
...
config.Data.outputDatasetTag = 'ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-'
