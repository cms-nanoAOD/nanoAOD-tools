...
config.General.requestName = 'ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-pow'
...
config.Data.outputDatasetTag = 'ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-pow'
