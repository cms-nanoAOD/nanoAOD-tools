...
config.General.requestName = 'TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_RunIIAutumn'
...
config.Data.outputDatasetTag = 'TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_RunIIAutumn'
