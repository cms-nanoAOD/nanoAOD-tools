...
config.General.requestName = 'DoubleEG_Run2017C-02Apr2020-v1'
...
config.Data.inputDataset = '/DoubleEG/Run2017C-02Apr2020-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'DoubleEG_Run2017C-02Apr2020-v1'
