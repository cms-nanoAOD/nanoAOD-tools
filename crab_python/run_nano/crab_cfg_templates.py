...
config.JobType.inputFiles = ['job_mc_crab.py', '../../scripts/haddnano.py', 'keep_and_drop_bff.txt']
...
# hadd nano will not be needed once nano tools are in cmssw
config.JobType.inputFiles = ['job_data_crab.py', '../../scripts/haddnano.py', 'keep_and_drop_bff.txt', '{json}''] 
config.JobType.sendPythonFolder = True
config.section_('Data')
config.Data.inputDataset = '{das}'
#config.Data.inputDBS = 'phys03'
