...
p=PostProcessor(".",inputFiles(), "Jet_pt>15 && Muon_pt > 9", modules=[jetmetUncertainties2017AK4PuppiAll(), btagSF2017(), muonScaleRes2017(), PrefCorr2017(), puAutoWeight_2017(), lepSFTrig2017(), lepSFID2017(), lepSFISO2017(),vbfhmmModule2017()], provenance=True,fwkJobReport=True,jsonInput=runsAndLumis()) 
