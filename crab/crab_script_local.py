...
p=PostProcessor('.', ['/eos/home-a/adeiorio/Wprime/nosynch/TT_Mtt-1000toInf_2016_1.root'], '', modules=[MCweight_writer(), MET_HLT_Filter(), lepSF_2017(), btagSF2017], histFileName="histOut.root",histDirName="plots", provenance=True, fwkJobReport=True)
p.run()
print 'DONE'
